...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch % 1 == 0 or epoch + 1 == args.epochs):
            PATH_glance = '/mnt/storage1/yunsung/imagenet_result/only_glance_12/glance/' 
            ...
            PATH_classification = '/mnt/storage1/yunsung/imagenet_result/only_glance_12/classification/'
            ...
            with open("/mnt/storage1/yunsung/imagenet_result/only_glance_12/result/ouput.pkl", 'wb') as f:
                    pickle.dump({'acc1': epoch_acc1_, 'acc5': epoch_acc5_,
                                'loss': loss_ }, f)
        with open("/mnt/storage1/yunsung/imagenet_result/only_glance_12/result/ouput_.pkl", 'wb') as f:
                    pickle.dump({'acc1': epoch_acc1_, 'acc5': epoch_acc5_,
                                'loss': loss_ }, f)
